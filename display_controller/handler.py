...
class DisplayHandler:
    ...
    def start(self):
        try:
            ...
            y_starting_point = (self.display.height / 2) - ((self.card_settings["height"] / 2 ) * math.floor(self.display.height / self.card_settings["height"]) ) - self.card_settings["margin_y"]
